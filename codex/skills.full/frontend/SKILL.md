...
name: frontend
description: |-
  Converted from Claude slash command: 프론트엔드 UI 개발
---

<!-- AUTO-GENERATED by codex-bridge.sh from $AGENT_HARNESS_BASELINE_HOME/claude/commands/frontend.md. Do not edit this generated copy. -->
