...
name: getdesign
description: |-
  Converted from Claude slash command: getdesign
---

<!-- AUTO-GENERATED by codex-bridge.sh from $AGENT_HARNESS_BASELINE_HOME/claude/commands/getdesign.md. Do not edit this generated copy. -->
